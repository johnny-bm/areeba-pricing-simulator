...
export const PRICING_SORT_OPTIONS = {
  ...
  PRICE: { field: 'price' as const, direction: 'asc' as const },
  CATEGORY: { field: 'category' as const, direction: 'asc' as const },
  CREATED: { field: 'createdAt' as const, direction: 'desc' as const },
} as const;
