 ...
 */
export function applyAutoAddLogic(currentSelectedItems, clientConfig, pricingServices, autoAddConfig, serviceMappings) {
 ...
 */
export function calculateServiceQuantity(service, clientConfig, autoAddConfig, serviceMappings) {
    const configValues = clientConfig.configValues;
    let totalQuantity = 0;
 ...
 */
function convertToLegacyConfig(dynamicConfig) {
 ...
 */
export function removeAutoAddedServices(currentSelectedItems, clientConfig, autoAddConfig, serviceMappings) {
    const configValues = clientConfig.configValues;
 ...
 */
export function updateServiceMappings(serviceMappings, serviceId, mapping) {
 ...
 */
export function updateAutoAddConfig(autoAddConfig, configFieldId, serviceIds, quantityMappings) {
    const updated = {
