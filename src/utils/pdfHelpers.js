...
function generateConfigurationHTML(data) {
...
function generateGlobalDiscountHTML(data) {
...
function convertDynamicToLegacy(dynamicConfig) {
    return {
...
function generateHTMLReport(data) {
    const calculateRowTotal = (selectedItem) => {
